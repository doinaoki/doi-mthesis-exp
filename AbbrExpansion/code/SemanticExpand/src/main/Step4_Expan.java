...
//        for (int o = 1; o <= 9; o++) {
//            rank = GlobleVariable.rantk[o-1];
//            GlobleVariable.testProjectName = "data" + o;
//            GlobleVariable.testSampleFromAddAbbrAndHResultFile = "out-abbrAndHResult.csv";
//            GlobleVariable.testMyExpansionFile = "out-myExpansionAll.csv";
//
//            System.setOut(new PrintStream(GlobleVariable.testMyExpansionFile));
